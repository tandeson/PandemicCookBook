...
def makeRecipe( dirPathRecipe, sharedIngredentList ):
        ...
        r.addIngredient('Mushrooms', 3, 'cups, Dried Shittaki Mushrooms')
        ...
        steps= [
            ...
            ' Then add garlic and green onion and cook for a few minutes.Then add the mushrooms - satue for a minute.',
