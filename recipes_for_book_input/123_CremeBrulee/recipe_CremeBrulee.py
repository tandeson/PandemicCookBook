...
def makeRecipe( dirPathRecipe, sharedIngredentList ):
        ...
        steps = [
            ...
            'Put the Egg Yolks and Sugar in a bowl, and whisk until it lightens in color.',
            'Add in the Heavy Cream, Vanilla and salt. For a differet flavor - you can replace 0.5 cups of Heavy Cream '
            'with Irish Cream.',
            'Gently whisk until the mixture is uniform.',
            ...
            'When ready to top - sprinkle sugar over the top and then use a kitchen torch to melt. Let sit for 15 minutes before serving.'
            ]
        for s in steps:
