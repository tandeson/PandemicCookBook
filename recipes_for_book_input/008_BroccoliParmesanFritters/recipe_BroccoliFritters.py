...
def makeRecipe( dirPathRecipe, sharedIngredentList ):
        ...
        """
        r = MyRecipe('Broccoli Parmesan Fritters',"Sides", sharedIngredentList)
        ...
        r.addStep( 
            ...
            [
                ...
                RecipeStep('Add the flour, cheese, garlic, salt and pepper.'),
                RecipeStep('add the somewhat cooled broccoli and mash with a fork.'),
                ...
                RecipeStep('Once mashed a bit, stir or fold the ingredients together '
                           'the rest of the way with a spoon.'),
                RecipeStep('Adjust seasonings to taste.'),
