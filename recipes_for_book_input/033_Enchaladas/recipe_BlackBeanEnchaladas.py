...
def makeRecipe( dirPathRecipe, sharedIngredentList ):
        ...
        """
        r = MyRecipe('Black Bean Enchiladas', sharedIngredentList)
        ...
        steps= [
            ...
            'Mix all the filing in the bowl well, and set aside.',
            'Heat a frying pan to medium heat, and pace a small amount of oil in it.',
