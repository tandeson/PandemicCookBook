...
def makeRecipe( dirPathRecipe, sharedIngredentList ):
        ...
        # Add Steps and Notes
        steps = [
            'First, rinse the wild rice and add it to a small bowl to soak in cold water for 15 to 30 minutes.',
            ...
            'the onion, garlic, and mushrooms. Then, saute for 15 minutes until the onions and mushrooms are beginning to'
            ...
            'Bring the pot of soup to a boil. Then, reduce the heat to a simmer and cook covered for 35 to 40 minutes.',
            'Add Quinoa, stir, then turn off heat and let sit for 15 minutes with the lid on to finish cooking.',
