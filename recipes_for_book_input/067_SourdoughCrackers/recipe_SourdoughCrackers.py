...
def makeRecipe( dirPathRecipe, sharedIngredentList ):
        ...
        """
        r = MyRecipe('Sourdough Crackers', sharedIngredentList)
        ...
        steps = [
            ...
            'Working with one piece at a time, roll the dough to about 1/16" thick. The dough will have ragged, uneven edges; that\'s '
            'OK. Just try to make it as even as possible.',
            ...
            'both top to bottom, and front to back; this will help the crackers brown evenly.',
