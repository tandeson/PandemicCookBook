...
def makeRecipe( dirPathRecipe, sharedIngredentList ):
        ...
        r.addIngredient('Extra Virgin Olive Oil', 1, 'tablespoon approx')
        ...
        steps = [
            ...
            'Preheat the oven to 350 deg F. Very lightly flour a piece of parchment, your rolling pin, and the top of the dough.',
